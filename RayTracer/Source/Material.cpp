...
bool Metal::Scatter(const ray_t& ray, const raycastHit_t& raycastHit, color3_t& attenuation, ray_t& scatter) const
{
        ...
        glm::vec3 reflected = Reflect(ray.direction, glm::normalize(raycastHit.normal)); //function with raycast hit direction and normal
        ...
        auto result = glm::dot(scatter.direction, raycastHit.normal);
